...
export const GameBoard = () => {
  return (
    <div className="aspect-video w-full bg-slate-800/50 border-4 border-slate-900/80 rounded-lg shadow-inner overflow-hidden">
      <div 
          ...
          return (
            <div
              ...
              className={cn(
                ...
                isPath ? 'bg-green-800/40' : 'bg-green-900/30 hover:bg-green-800/50',
